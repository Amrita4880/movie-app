import { Button, CardContent, FormControl, GridList, GridListTile, GridListTileBar, InputLabel, ListItemText, MenuItem, Select, Typography } from '@material-ui/core';
        ...
        return (
            <div>
                ...
                <div className="flex-container">
                    <div className="left">
                        <GridList cellHeight={250} cols={4} className={classes.gridListMain}>
                        ...
                        <Card>
                            <CardContent>
                                ...
                                <FormControl className={classes.FormControl}>
                                    ...
                                    <Select
                                        multiple
                                        input={<Input id="select-multiple-chckbox-genre" />}
